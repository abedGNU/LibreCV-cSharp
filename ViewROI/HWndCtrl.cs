...
namespace ViewROI
{
    ...
    public class HWndCtrl
    {
        ...
        // Abed 2017-12-07. Add the get to access the zoom factor from outside,
        // to syncronize different zoom from different controls
        ...
        public HWndCtrl(HWindowControl view)
        {
            ...
            // Abed 2017-07-08. imageWidth =0 when the contstuctor is called!
            // zoomWndFactor wil be 0.
        ...
        /// Abed 2017-12-07. if windowWidth > imageWidth
        /// (imageWidth / windowWidth)=0 so step=0. to solve cast to double (imageWidth / windowWidth)
        /// </summary>
        public void setGUICompRangeX(int[] xRange, int Init)
        {
            ...
            prevCompX = Init;
            stepSizeX = ((double)imageWidth / cRangeX) * ((double)imageWidth / windowWidth);
        ...
        public void setGUICompRangeY(int[] yRange, int Init)
        {
            ...
            prevCompY = Init;
            stepSizeY = ((double)imageHeight / cRangeY) * ((double)imageHeight / windowHeight);
        }
